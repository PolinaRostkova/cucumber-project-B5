...
import io.loop.pages.LoginPageDocuport;
...
LoginPageDocuport loginPageDocuport =  new LoginPageDocuport();
    ...
    public void user_enters_username_for_client() {
        BrowserUtils.waitForClickable(loginPageDocuport.usernameInput, DocuportConstants.LARGE);
        assertTrue(loginPageDocuport.loginButton.isDisplayed());
        loginPageDocuport.usernameInput.sendKeys(DocuportConstants.USERNAME_CLIENT);
    }
    ...
    public void user_clicks_login_button() throws InterruptedException {
        ...
        Thread.sleep(3000);
        loginPageDocuport.contButton.click();
    }


    @Then("user should be able to see the home page for client")
    public void user_should_be_able_to_see_the_home_page_for_client() {
        assertTrue("User didn't log in and cant see home page", BrowserUtils.waitForVisibility(loginPageDocuport.docuportImage, DocuportConstants.LARGE).isDisplayed());
    }
